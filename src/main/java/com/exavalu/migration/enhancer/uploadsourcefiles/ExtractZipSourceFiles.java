...
import com.exavalu.migration.enhancer.generateuniquestringid.UniqueStringIdGenerator;
...
public class ExtractZipSourceFiles {
    ...
    public static boolean extractZip(MultipartFile file, String destDirectory) {
        ...
        try (ZipInputStream zipInputStream = new ZipInputStream(file.getInputStream())) {
            ...
            String path = destDirectory + File.separator + file.getOriginalFilename().replace(".zip", "_") + formattedDateTime;
